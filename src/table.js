...
export class Table {
	constructor(gas) {
        ...
        this.attributes = ['open','close','high','low','volume','pe', 'eps', 'beta', 'dividend','earnings', 'marketcap']
        ...
        addAttributesName(){
            ...
            let attributesNames = this.svg.selectAll("labels")
		...
		updateDetails(data) {
            ...
            attributesValues.join("text")
                .attr('class' , 'values')
              .attr("x", 100)
              .attr("y", function(d,i){ return 9+i*(size+5) + (size/2)}) 
              .style("fill", 'black')
